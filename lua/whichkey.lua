...
local setup = {
	plugins = {
		...
		presets = {
			operators = false, -- adds help for operators like d, y, ... and registers
	...
	-- to enable all native operators, set the preset / operators pllugin above
	-- oerators = { gc = "Comments" },
	key_labels = {
	...
	triggers_blacklist = {
		-- list of mode / prefixes that should never be hooked by which_key
